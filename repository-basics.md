...
- Learn about [Branching & Merging]({{ '/branching-merging' | relative_url }})
- Understand [Pull Requests]({{ '/pull-requests' | relative_url }})
- Explore [Collaboration]({{ '/collaboration' | relative_url }}) workflows
