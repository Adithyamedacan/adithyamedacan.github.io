...
- Learn about [Collaboration]({{ '/collaboration' | relative_url }}) workflows
- Explore [Best Practices]({{ '/best-practices' | relative_url }})
- Review [Repository Basics]({{ '/repository-basics' | relative_url }})
